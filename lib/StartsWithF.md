...
[`fchown`](https://www.man7.org/linux/man-pages/man3/fchown.3p.html) - change owner and group of a file
...
[`fdimf`](https://www.man7.org/linux/man-pages/man3/fdimf.3.html) - positive difference
...
[`fesetexceptflag`](https://www.man7.org/linux/man-pages/man3/fesetexceptflag.3.html) - floating-point rounding and exception handling
...
[`fgetfilecon`](https://www.man7.org/linux/man-pages/man3/fgetfilecon.3.html) - get SELinux security context of a file
...
[`finitef`](https://www.man7.org/linux/man-pages/man3/finitef.3.html) - BSD floating-point classification functions
...
[`flatpak-make-current`](https://www.man7.org/linux/man-pages/man1/flatpak-make-current.1.html) - Make a specific version of an app current
...
[`floorl`](https://www.man7.org/linux/man-pages/man3/floorl.3p.html) - floor function
...
[`fminl`](https://www.man7.org/linux/man-pages/man3/fminl.3.html) - determine minimum of two floating-point numbers
...
[`form_cursor`](https://www.man7.org/linux/man-pages/man3/form_cursor.3x.html) - position a form window cursor
...
[`form_page`](https://www.man7.org/linux/man-pages/man3/form_page.3x.html) - set and get form page number
...
[`freecon`](https://www.man7.org/linux/man-pages/man3/freecon.3.html) - get SELinux security context of a process
...
[`frexpf`](https://www.man7.org/linux/man-pages/man3/frexpf.3p.html) - extract mantissa and exponent from a double precision number
...
[`__fsetlocking`](https://www.man7.org/linux/man-pages/man3/__fsetlocking.3.html) - interfaces to stdio FILE structure
...
[`fstat64`](https://www.man7.org/linux/man-pages/man2/fstat64.2.html) - get file status
...
[`ftrylockfile`](https://www.man7.org/linux/man-pages/man3/ftrylockfile.3p.html) - stdio locking functions
...
[`function::cpu_clock_us`](https://www.man7.org/linux/man-pages/man3/function::cpu_clock_us.3stap.html) - Number of microseconds on the given cpu's clock
...
[`function::fullpath_struct_path`](https://www.man7.org/linux/man-pages/man3/function::fullpath_struct_path.3stap.html) - get the full path
...
[`function::inode_path`](https://www.man7.org/linux/man-pages/man3/function::inode_path.3stap.html) - get the path to an inode
...
[`function::print_syms`](https://www.man7.org/linux/man-pages/man3/function::print_syms.3stap.html) - Print out kernel stack from string
...
[`function::qsq_start`](https://www.man7.org/linux/man-pages/man3/function::qsq_start.3stap.html) - Function to reset the stats for a queue
[`function::qsq_throughput`](https://www.man7.org/linux/man-pages/man3/function::qsq_throughput.3stap.html) - Number of requests served per unit time
[`function::qsq_utilization`](https://www.man7.org/linux/man-pages/man3/function::qsq_utilization.3stap.html) - Fraction of time that any request was being serviced
[`function::qsq_wait_queue_length`](https://www.man7.org/linux/man-pages/man3/function::qsq_wait_queue_length.3stap.html) - length of wait queue
[`function::qsq_wait_time`](https://www.man7.org/linux/man-pages/man3/function::qsq_wait_time.3stap.html) - Amount of time in queue + service per request
[`function::qs_run`](https://www.man7.org/linux/man-pages/man3/function::qs_run.3stap.html) - Function to record being moved from wait queue to being serviced
[`function::qs_wait`](https://www.man7.org/linux/man-pages/man3/function::qs_wait.3stap.html) - Function to record enqueue requests
[`function::raise`](https://www.man7.org/linux/man-pages/man3/function::raise.3stap.html) - raise a signal in the current thread
[`function::randint`](https://www.man7.org/linux/man-pages/man3/function::randint.3stap.html) - Return a random number between [0,n)
[`function::read_stopwatch_ms`](https://www.man7.org/linux/man-pages/man3/function::read_stopwatch_ms.3stap.html) - Reads the time in milliseconds for a stopwatch
[`function::read_stopwatch_ns`](https://www.man7.org/linux/man-pages/man3/function::read_stopwatch_ns.3stap.html) - Reads the time in nanoseconds for a stopwatch
[`function::read_stopwatch_s`](https://www.man7.org/linux/man-pages/man3/function::read_stopwatch_s.3stap.html) - Reads the time in seconds for a stopwatch
[`function::read_stopwatch_us`](https://www.man7.org/linux/man-pages/man3/function::read_stopwatch_us.3stap.html) - Reads the time in microseconds for a stopwatch
[`function::real_mount`](https://www.man7.org/linux/man-pages/man3/function::real_mount.3stap.html) - get the 'struct mount' pointer
[`function::register`](https://www.man7.org/linux/man-pages/man3/function::register.3stap.html) - Return the signed value of the named CPU register
[`function::registers_valid`](https://www.man7.org/linux/man-pages/man3/function::registers_valid.3stap.html) - Determines validity of register and u_register in current context
[`function::regparm`](https://www.man7.org/linux/man-pages/man3/function::regparm.3stap.html) - Specify regparm value used to compile function
[`function::remote_id`](https://www.man7.org/linux/man-pages/man3/function::remote_id.3stap.html) - The index of this instance in a remote execution.
[`function::remote_uri`](https://www.man7.org/linux/man-pages/man3/function::remote_uri.3stap.html) - The name of this instance in a remote execution.
[`function::returnstr`](https://www.man7.org/linux/man-pages/man3/function::returnstr.3stap.html) - Formats the return value as a string
[`function::return_str`](https://www.man7.org/linux/man-pages/man3/function::return_str.3stap.html) - Formats the return value as a string
[`function::returnval`](https://www.man7.org/linux/man-pages/man3/function::returnval.3stap.html) - Possible return value of probed function
[`function::reverse_path_walk`](https://www.man7.org/linux/man-pages/man3/function::reverse_path_walk.3stap.html) - get the full dirent path
[`function::rlimit_from_str`](https://www.man7.org/linux/man-pages/man3/function::rlimit_from_str.3stap.html) - Symbolic string associated with resource limit code
[`function::s32_arg`](https://www.man7.org/linux/man-pages/man3/function::s32_arg.3stap.html) - Return function argument as signed 32-bit value
[`function::s64_arg`](https://www.man7.org/linux/man-pages/man3/function::s64_arg.3stap.html) - Return function argument as signed 64-bit value
[`function::sa_flags_str`](https://www.man7.org/linux/man-pages/man3/function::sa_flags_str.3stap.html) - Returns the string representation of sa_flags
[`function::sa_handler` -](https://www.man7.org/linux/man-pages/man3/function::sa_handler.3stap.html) - (no description)
[`function::sa_handler_str`](https://www.man7.org/linux/man-pages/man3/function::sa_handler_str.3stap.html) - Returns the string representation of an sa_handler
[`function::set_int_arg`](https://www.man7.org/linux/man-pages/man3/function::set_int_arg.3stap.html) - Set function argument as signed int
[`function::set_kernel_char`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_char.3stap.html) - Writes a char value to kernel memory
[`function::set_kernel_int`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_int.3stap.html) - Writes an int value to kernel memory
[`function::set_kernel_long`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_long.3stap.html) - Writes a long value to kernel memory
[`function::set_kernel_pointer`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_pointer.3stap.html) - Writes a pointer value to kernel memory.
[`function::set_kernel_short`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_short.3stap.html) - Writes a short value to kernel memory
[`function::set_kernel_string`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_string.3stap.html) - Writes a string to kernel memory
[`function::set_kernel_string_n`](https://www.man7.org/linux/man-pages/man3/function::set_kernel_string_n.3stap.html) - Writes a string of given length to kernel memory
[`function::set_long_arg`](https://www.man7.org/linux/man-pages/man3/function::set_long_arg.3stap.html) - Set argument as signed long
[`function::set_longlong_arg`](https://www.man7.org/linux/man-pages/man3/function::set_longlong_arg.3stap.html) - Set function argument as 64-bit value
[`function::set_pointer_arg`](https://www.man7.org/linux/man-pages/man3/function::set_pointer_arg.3stap.html) - Set function argument as pointer value
[`function::set_s32_arg`](https://www.man7.org/linux/man-pages/man3/function::set_s32_arg.3stap.html) - Set function argument as signed 32-bit value
[`function::set_s64_arg`](https://www.man7.org/linux/man-pages/man3/function::set_s64_arg.3stap.html) - Set function argument as signed 64-bit value
[`function::set_u32_arg`](https://www.man7.org/linux/man-pages/man3/function::set_u32_arg.3stap.html) - Set function argument as unsigned 32-bit value
[`function::set_u64_arg`](https://www.man7.org/linux/man-pages/man3/function::set_u64_arg.3stap.html) - Set function argument as unsigned 64-bit value
[`function::set_uint_arg`](https://www.man7.org/linux/man-pages/man3/function::set_uint_arg.3stap.html) - Set argument as unsigned int
[`function::set_ulong_arg`](https://www.man7.org/linux/man-pages/man3/function::set_ulong_arg.3stap.html) - Set function argument as unsigned long
[`function::set_ulonglong_arg`](https://www.man7.org/linux/man-pages/man3/function::set_ulonglong_arg.3stap.html) - Set function argument as 64-bit value
[`function::set_user_char`](https://www.man7.org/linux/man-pages/man3/function::set_user_char.3stap.html) - Writes a char value to user memory
[`function::set_user_int`](https://www.man7.org/linux/man-pages/man3/function::set_user_int.3stap.html) - Writes an int value to user memory
[`function::set_user_long`](https://www.man7.org/linux/man-pages/man3/function::set_user_long.3stap.html) - Writes a long value to user memory
[`function::set_user_pointer`](https://www.man7.org/linux/man-pages/man3/function::set_user_pointer.3stap.html) - Writes a pointer value to user memory.
[`function::set_user_short`](https://www.man7.org/linux/man-pages/man3/function::set_user_short.3stap.html) - Writes a short value to user memory
[`function::set_user_string`](https://www.man7.org/linux/man-pages/man3/function::set_user_string.3stap.html) - Writes a string to user memory
[`function::set_user_string_arg`](https://www.man7.org/linux/man-pages/man3/function::set_user_string_arg.3stap.html) - Writes a string to user memory.
[`function::set_user_string_n`](https://www.man7.org/linux/man-pages/man3/function::set_user_string_n.3stap.html) - Writes a string of given length to user memory
[`function::sid`](https://www.man7.org/linux/man-pages/man3/function::sid.3stap.html) - Returns the session ID of the current process
[`function::signal_str`](https://www.man7.org/linux/man-pages/man3/function::signal_str.3stap.html) - Returns the string representation of a signal number
[`function::sigset_mask_str`](https://www.man7.org/linux/man-pages/man3/function::sigset_mask_str.3stap.html) - Returns the string representation of a sigset
[`function::sock_fam_num2str`](https://www.man7.org/linux/man-pages/man3/function::sock_fam_num2str.3stap.html) - Given a protocol family number, return a string representation
[`function::sock_fam_str2num`](https://www.man7.org/linux/man-pages/man3/function::sock_fam_str2num.3stap.html) - Given a protocol family name (string), return the corresponding protocol family number
[`function::sock_prot_num2str`](https://www.man7.org/linux/man-pages/man3/function::sock_prot_num2str.3stap.html) - Given a protocol number, return a string representation
[`function::sock_prot_str2num`](https://www.man7.org/linux/man-pages/man3/function::sock_prot_str2num.3stap.html) - Given a protocol name (string), return the corresponding protocol number
[`function::sock_state_num2str`](https://www.man7.org/linux/man-pages/man3/function::sock_state_num2str.3stap.html) - Given a socket state number, return a string representation
[`function::sock_state_str2num`](https://www.man7.org/linux/man-pages/man3/function::sock_state_str2num.3stap.html) - Given a socket state string, return the corresponding state number
[`function::speculate`](https://www.man7.org/linux/man-pages/man3/function::speculate.3stap.html) - Store a string for possible output later
[`function::speculation`](https://www.man7.org/linux/man-pages/man3/function::speculation.3stap.html) - Allocate a new id for speculative output
[`function::sprint_backtrace`](https://www.man7.org/linux/man-pages/man3/function::sprint_backtrace.3stap.html) - Return stack back trace as string
[`function::sprint_loadavg`](https://www.man7.org/linux/man-pages/man3/function::sprint_loadavg.3stap.html) - Report a pretty-printed load average
[`function::sprint_stack`](https://www.man7.org/linux/man-pages/man3/function::sprint_stack.3stap.html) - Return stack for kernel addresses from string
[`function::sprint_syms`](https://www.man7.org/linux/man-pages/man3/function::sprint_syms.3stap.html) - Return stack for kernel addresses from string
[`function::sprint_ubacktrace`](https://www.man7.org/linux/man-pages/man3/function::sprint_ubacktrace.3stap.html) - Return stack back trace for current user-space task as string.
[`function::sprint_ustack`](https://www.man7.org/linux/man-pages/man3/function::sprint_ustack.3stap.html) - Return stack for the current task from string.
[`function::sprint_usyms`](https://www.man7.org/linux/man-pages/man3/function::sprint_usyms.3stap.html) - Return stack for user addresses from string
[`function::stack`](https://www.man7.org/linux/man-pages/man3/function::stack.3stap.html) - Return address at given depth of kernel stack backtrace
[`function::stack_size`](https://www.man7.org/linux/man-pages/man3/function::stack_size.3stap.html) - Return the size of the kernel stack
[`function::stack_unused`](https://www.man7.org/linux/man-pages/man3/function::stack_unused.3stap.html) - Returns the amount of kernel stack currently available
[`function::stack_used`](https://www.man7.org/linux/man-pages/man3/function::stack_used.3stap.html) - Returns the amount of kernel stack used
[`function::start_stopwatch`](https://www.man7.org/linux/man-pages/man3/function::start_stopwatch.3stap.html) - Start a stopwatch
[`function::stop_stopwatch`](https://www.man7.org/linux/man-pages/man3/function::stop_stopwatch.3stap.html) - Stop a stopwatch
[`function::stp_pid`](https://www.man7.org/linux/man-pages/man3/function::stp_pid.3stap.html) - The process id of the stapio process
[`function::stringat`](https://www.man7.org/linux/man-pages/man3/function::stringat.3stap.html) - Returns the char at a given position in the string
[`function::string_quoted`](https://www.man7.org/linux/man-pages/man3/function::string_quoted.3stap.html) - Quotes a given string
[`function::string_to_fp`](https://www.man7.org/linux/man-pages/man3/function::string_to_fp.3stap.html) - Convert the given string into floating point
[`function::strlen`](https://www.man7.org/linux/man-pages/man3/function::strlen.3stap.html) - Returns the length of a string
[`function::strpos`](https://www.man7.org/linux/man-pages/man3/function::strpos.3stap.html) - Returns location of a substring within another string
[`function::str_replace`](https://www.man7.org/linux/man-pages/man3/function::str_replace.3stap.html) - str_replace Replaces all instances of a substring with another
[`function::strtol`](https://www.man7.org/linux/man-pages/man3/function::strtol.3stap.html) - Convert a string to a long
[`function::substr`](https://www.man7.org/linux/man-pages/man3/function::substr.3stap.html) - Returns a substring
[`function::switch_file`](https://www.man7.org/linux/man-pages/man3/function::switch_file.3stap.html) - switch to the next output file
[`function::symdata`](https://www.man7.org/linux/man-pages/man3/function::symdata.3stap.html) - Return the kernel symbol and module offset for the address
[`function::symfile`](https://www.man7.org/linux/man-pages/man3/function::symfile.3stap.html) - Return the file name of a given address.
[`function::symfileline`](https://www.man7.org/linux/man-pages/man3/function::symfileline.3stap.html) - Return the file name and line number of an address.
[`function::symline`](https://www.man7.org/linux/man-pages/man3/function::symline.3stap.html) - Return the line number of an address.
[`function::symname`](https://www.man7.org/linux/man-pages/man3/function::symname.3stap.html) - Return the kernel symbol associated with the given address
[`function::system`](https://www.man7.org/linux/man-pages/man3/function::system.3stap.html) - Issue a command to the system
[`function::target`](https://www.man7.org/linux/man-pages/man3/function::target.3stap.html) - Return the process ID of the target process
[`function::target_set_pid`](https://www.man7.org/linux/man-pages/man3/function::target_set_pid.3stap.html) - Does pid descend from target process?
[`function::target_set_report`](https://www.man7.org/linux/man-pages/man3/function::target_set_report.3stap.html) - Print a report about the target set
[`function::task_ancestry`](https://www.man7.org/linux/man-pages/man3/function::task_ancestry.3stap.html) - The ancestry of the given task
[`function::task_backtrace`](https://www.man7.org/linux/man-pages/man3/function::task_backtrace.3stap.html) - Hex backtrace of an arbitrary task
[`function::task_cpu`](https://www.man7.org/linux/man-pages/man3/function::task_cpu.3stap.html) - The scheduled cpu of the task
[`function::task_current`](https://www.man7.org/linux/man-pages/man3/function::task_current.3stap.html) - The current task_struct of the current task
[`function::task_cwd_path`](https://www.man7.org/linux/man-pages/man3/function::task_cwd_path.3stap.html) - get the path struct pointer for a task's current working directory
[`function::task_dentry_path`](https://www.man7.org/linux/man-pages/man3/function::task_dentry_path.3stap.html) - get the full dentry path
[`function::task_egid`](https://www.man7.org/linux/man-pages/man3/function::task_egid.3stap.html) - The effective group identifier of the task
[`function::task_euid`](https://www.man7.org/linux/man-pages/man3/function::task_euid.3stap.html) - The effective user identifier of the task
[`function::task_execname`](https://www.man7.org/linux/man-pages/man3/function::task_execname.3stap.html) - The name of the task
[`function::task_exe_file`](https://www.man7.org/linux/man-pages/man3/function::task_exe_file.3stap.html) - get the file struct pointer for a task's executable file
[`function::task_fd_lookup`](https://www.man7.org/linux/man-pages/man3/function::task_fd_lookup.3stap.html) - get the file struct for a task's fd
[`function::task_gid`](https://www.man7.org/linux/man-pages/man3/function::task_gid.3stap.html) - The group identifier of the task
[`function::task_max_file_handles`](https://www.man7.org/linux/man-pages/man3/function::task_max_file_handles.3stap.html) - The max number of open files for the task
[`function::task_nice`](https://www.man7.org/linux/man-pages/man3/function::task_nice.3stap.html) - The nice value of the task
[`function::task_ns_egid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_egid.3stap.html) - The effective group identifier of the task
[`function::task_ns_euid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_euid.3stap.html) - The effective user identifier of the task
[`function::task_ns_gid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_gid.3stap.html) - The group identifier of the task as seen in a namespace
[`function::task_ns_pid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_pid.3stap.html) - The process identifier of the task
[`function::task_ns_tid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_tid.3stap.html) - The thread identifier of the task as seen in a namespace
[`function::task_ns_uid`](https://www.man7.org/linux/man-pages/man3/function::task_ns_uid.3stap.html) - The user identifier of the task
[`function::task_open_file_handles`](https://www.man7.org/linux/man-pages/man3/function::task_open_file_handles.3stap.html) - The number of open files of the task
[`function::task_parent`](https://www.man7.org/linux/man-pages/man3/function::task_parent.3stap.html) - The task_struct of the parent task
[`function::task_pid`](https://www.man7.org/linux/man-pages/man3/function::task_pid.3stap.html) - The process identifier of the task
[`function::task_prio`](https://www.man7.org/linux/man-pages/man3/function::task_prio.3stap.html) - The priority value of the task
[`function::task_start_time`](https://www.man7.org/linux/man-pages/man3/function::task_start_time.3stap.html) - Start time of the given task
[`function::task_state`](https://www.man7.org/linux/man-pages/man3/function::task_state.3stap.html) - The state of the task
[`function::task_stime`](https://www.man7.org/linux/man-pages/man3/function::task_stime.3stap.html) - System time of the task
[`function::task_tid`](https://www.man7.org/linux/man-pages/man3/function::task_tid.3stap.html) - The thread identifier of the task
[`function::task_time_string`](https://www.man7.org/linux/man-pages/man3/function::task_time_string.3stap.html) - Human readable string of task time usage
[`function::task_time_string_tid`](https://www.man7.org/linux/man-pages/man3/function::task_time_string_tid.3stap.html) - Human readable string of task time usage
[`function::task_uid`](https://www.man7.org/linux/man-pages/man3/function::task_uid.3stap.html) - The user identifier of the task
[`function::task_utime`](https://www.man7.org/linux/man-pages/man3/function::task_utime.3stap.html) - User time of the task
[`function::tcpmib_filter_key`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_filter_key.3stap.html) - Default filter function for tcpmib.* probes
[`function::tcpmib_get_state`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_get_state.3stap.html) - Get a socket's state
[`function::tcpmib_local_addr`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_local_addr.3stap.html) - Get the source address
[`function::tcpmib_local_port`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_local_port.3stap.html) - Get the local port
[`function::tcpmib_remote_addr`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_remote_addr.3stap.html) - Get the remote address
[`function::tcpmib_remote_port`](https://www.man7.org/linux/man-pages/man3/function::tcpmib_remote_port.3stap.html) - Get the remote port
[`function::text_str`](https://www.man7.org/linux/man-pages/man3/function::text_str.3stap.html) - Escape any non-printable chars in a string
[`function::text_strn`](https://www.man7.org/linux/man-pages/man3/function::text_strn.3stap.html) - Escape any non-printable chars in a string
[`function::thread_indent`](https://www.man7.org/linux/man-pages/man3/function::thread_indent.3stap.html) - returns an amount of space with the current task information
[`function::thread_indent_depth`](https://www.man7.org/linux/man-pages/man3/function::thread_indent_depth.3stap.html) - returns the nested-depth of the current task
[`function::tid`](https://www.man7.org/linux/man-pages/man3/function::tid.3stap.html) - Returns the thread ID of a target process
[`function::tokenize`](https://www.man7.org/linux/man-pages/man3/function::tokenize.3stap.html) - Return the next non-empty token in a string
[`function::tz_ctime`](https://www.man7.org/linux/man-pages/man3/function::tz_ctime.3stap.html) - Convert seconds since epoch into human readable date/time string, with local time zone
[`function::tz_gmtoff`](https://www.man7.org/linux/man-pages/man3/function::tz_gmtoff.3stap.html) - Return local time zone offset
[`function::tz_name`](https://www.man7.org/linux/man-pages/man3/function::tz_name.3stap.html) - Return local time zone name
[`function::u32_arg`](https://www.man7.org/linux/man-pages/man3/function::u32_arg.3stap.html) - Return function argument as unsigned 32-bit value
[`function::u64_arg`](https://www.man7.org/linux/man-pages/man3/function::u64_arg.3stap.html) - Return function argument as unsigned 64-bit value
[`function::uaddr`](https://www.man7.org/linux/man-pages/man3/function::uaddr.3stap.html) - User space address of current running task
[`function::ubacktrace`](https://www.man7.org/linux/man-pages/man3/function::ubacktrace.3stap.html) - Hex backtrace of current user-space task stack.
[`function::ucallers`](https://www.man7.org/linux/man-pages/man3/function::ucallers.3stap.html) - Return first n elements of user stack backtrace
[`function::udelay`](https://www.man7.org/linux/man-pages/man3/function::udelay.3stap.html) - microsecond delay
[`function::uid`](https://www.man7.org/linux/man-pages/man3/function::uid.3stap.html) - Returns the user ID of a target process
[`function::uint_arg`](https://www.man7.org/linux/man-pages/man3/function::uint_arg.3stap.html) - Return function argument as unsigned int
[`function::ulong_arg`](https://www.man7.org/linux/man-pages/man3/function::ulong_arg.3stap.html) - Return function argument as unsigned long
[`function::ulonglong_arg`](https://www.man7.org/linux/man-pages/man3/function::ulonglong_arg.3stap.html) - Return function argument as 64-bit value
[`function::umodname`](https://www.man7.org/linux/man-pages/man3/function::umodname.3stap.html) - Returns the (short) name of the user module.
[`function::u_register`](https://www.man7.org/linux/man-pages/man3/function::u_register.3stap.html) - Return the unsigned value of the named CPU register
[`function::usecs_to_string`](https://www.man7.org/linux/man-pages/man3/function::usecs_to_string.3stap.html) - Human readable string for given microseconds
[`function::user_buffer_quoted`](https://www.man7.org/linux/man-pages/man3/function::user_buffer_quoted.3stap.html) - Retrieves and quotes buffer from user space
[`function::user_buffer_quoted_error`](https://www.man7.org/linux/man-pages/man3/function::user_buffer_quoted_error.3stap.html) - Retrieves and quotes buffer from user space
[`function::user_char`](https://www.man7.org/linux/man-pages/man3/function::user_char.3stap.html) - Retrieves a char value stored in user space
[`function::user_char_error`](https://www.man7.org/linux/man-pages/man3/function::user_char_error.3stap.html) - Retrieves a char value stored in user space
[`function::user_char_warn`](https://www.man7.org/linux/man-pages/man3/function::user_char_warn.3stap.html) - Retrieves a char value stored in user space
[`function::user_int`](https://www.man7.org/linux/man-pages/man3/function::user_int.3stap.html) - Retrieves an int value stored in user space
[`function::user_int16`](https://www.man7.org/linux/man-pages/man3/function::user_int16.3stap.html) - Retrieves a 16-bit integer value stored in user space
[`function::user_int16_error`](https://www.man7.org/linux/man-pages/man3/function::user_int16_error.3stap.html) - Retrieves a 16-bit integer value stored in user space
[`function::user_int32`](https://www.man7.org/linux/man-pages/man3/function::user_int32.3stap.html) - Retrieves a 32-bit integer value stored in user space
[`function::user_int32_error`](https://www.man7.org/linux/man-pages/man3/function::user_int32_error.3stap.html) - Retrieves a 32-bit integer value stored in user space
[`function::user_int64`](https://www.man7.org/linux/man-pages/man3/function::user_int64.3stap.html) - Retrieves a 64-bit integer value stored in user space
[`function::user_int64_error`](https://www.man7.org/linux/man-pages/man3/function::user_int64_error.3stap.html) - Retrieves a 64-bit integer value stored in user space
[`function::user_int8`](https://www.man7.org/linux/man-pages/man3/function::user_int8.3stap.html) - Retrieves a 8-bit integer value stored in user space
[`function::user_int8_error`](https://www.man7.org/linux/man-pages/man3/function::user_int8_error.3stap.html) - Retrieves a 8-bit integer value stored in user space
[`function::user_int_error`](https://www.man7.org/linux/man-pages/man3/function::user_int_error.3stap.html) - Retrieves an int value stored in user space
[`function::user_int_warn`](https://www.man7.org/linux/man-pages/man3/function::user_int_warn.3stap.html) - Retrieves an int value stored in user space
[`function::user_long`](https://www.man7.org/linux/man-pages/man3/function::user_long.3stap.html) - Retrieves a long value stored in user space
[`function::user_long_error`](https://www.man7.org/linux/man-pages/man3/function::user_long_error.3stap.html) - Retrieves a long value stored in user space
[`function::user_long_warn`](https://www.man7.org/linux/man-pages/man3/function::user_long_warn.3stap.html) - Retrieves a long value stored in user space
[`function::user_mode`](https://www.man7.org/linux/man-pages/man3/function::user_mode.3stap.html) - Determines if probe point occurs in user-mode
[`function::user_short`](https://www.man7.org/linux/man-pages/man3/function::user_short.3stap.html) - Retrieves a short value stored in user space
[`function::user_short_error`](https://www.man7.org/linux/man-pages/man3/function::user_short_error.3stap.html) - Retrieves a short value stored in user space
[`function::user_short_warn`](https://www.man7.org/linux/man-pages/man3/function::user_short_warn.3stap.html) - Retrieves a short value stored in user space
[`function::user_string`](https://www.man7.org/linux/man-pages/man3/function::user_string.3stap.html) - Retrieves string from user space
[`function::user_string_n`](https://www.man7.org/linux/man-pages/man3/function::user_string_n.3stap.html) - Retrieves string of given length from user space
[`function::user_string_n_nofault`](https://www.man7.org/linux/man-pages/man3/function::user_string_n_nofault.3stap.html) - Retrieves string of given length from user space
[`function::user_string_nofault`](https://www.man7.org/linux/man-pages/man3/function::user_string_nofault.3stap.html) - Retrieves string from user space
[`function::user_string_n_quoted`](https://www.man7.org/linux/man-pages/man3/function::user_string_n_quoted.3stap.html) - Retrieves and quotes string from user space
[`function::user_string_n_warn`](https://www.man7.org/linux/man-pages/man3/function::user_string_n_warn.3stap.html) - Retrieves string from user space
[`function::user_string_quoted`](https://www.man7.org/linux/man-pages/man3/function::user_string_quoted.3stap.html) - Retrieves and quotes string from user space
[`function::user_string_quoted_utf16`](https://www.man7.org/linux/man-pages/man3/function::user_string_quoted_utf16.3stap.html) - Quote given user UTF-16 string.
[`function::user_string_quoted_utf32`](https://www.man7.org/linux/man-pages/man3/function::user_string_quoted_utf32.3stap.html) - Quote given user UTF-32 string.
[`function::user_string_utf16`](https://www.man7.org/linux/man-pages/man3/function::user_string_utf16.3stap.html) - Retrieves UTF-16 string from user memory
[`function::user_string_utf32`](https://www.man7.org/linux/man-pages/man3/function::user_string_utf32.3stap.html) - Retrieves UTF-32 string from user memory
[`function::user_string_warn`](https://www.man7.org/linux/man-pages/man3/function::user_string_warn.3stap.html) - Retrieves string from user space
[`function::user_uint16`](https://www.man7.org/linux/man-pages/man3/function::user_uint16.3stap.html) - Retrieves an unsigned 16-bit integer value stored in user space
[`function::user_uint16_error`](https://www.man7.org/linux/man-pages/man3/function::user_uint16_error.3stap.html) - Retrieves an unsigned 16-bit integer value stored in user space
[`function::user_uint32`](https://www.man7.org/linux/man-pages/man3/function::user_uint32.3stap.html) - Retrieves an unsigned 32-bit integer value stored in user space
[`function::user_uint32_error`](https://www.man7.org/linux/man-pages/man3/function::user_uint32_error.3stap.html) - Retrieves an unsigned 32-bit integer value stored in user space
[`function::user_uint64`](https://www.man7.org/linux/man-pages/man3/function::user_uint64.3stap.html) - Retrieves an unsigned 64-bit integer value stored in user space
[`function::user_uint64_error`](https://www.man7.org/linux/man-pages/man3/function::user_uint64_error.3stap.html) - Retrieves an unsigned 64-bit integer value stored in user space
[`function::user_uint8`](https://www.man7.org/linux/man-pages/man3/function::user_uint8.3stap.html) - Retrieves a unsigned 8-bit integer value stored in user space
[`function::user_uint8_error`](https://www.man7.org/linux/man-pages/man3/function::user_uint8_error.3stap.html) - Retrieves a unsigned 8-bit integer value stored in user space
[`function::user_ulong`](https://www.man7.org/linux/man-pages/man3/function::user_ulong.3stap.html) - Retrieves an unsigned long value stored in user space
[`function::user_ulong_error`](https://www.man7.org/linux/man-pages/man3/function::user_ulong_error.3stap.html) - Retrieves a unsigned long value stored in user space
[`function::user_ulong_warn`](https://www.man7.org/linux/man-pages/man3/function::user_ulong_warn.3stap.html) - Retrieves an unsigned long value stored in user space
[`function::user_ushort`](https://www.man7.org/linux/man-pages/man3/function::user_ushort.3stap.html) - Retrieves an unsigned short value stored in user space
[`function::user_ushort_error`](https://www.man7.org/linux/man-pages/man3/function::user_ushort_error.3stap.html) - Retrieves an unsigned short value stored in user space
[`function::user_ushort_warn`](https://www.man7.org/linux/man-pages/man3/function::user_ushort_warn.3stap.html) - Retrieves an unsigned short value stored in user space
[`function::usrdev2kerndev`](https://www.man7.org/linux/man-pages/man3/function::usrdev2kerndev.3stap.html) - Converts a user-space device number into the format used in the kernel
[`function::ustack`](https://www.man7.org/linux/man-pages/man3/function::ustack.3stap.html) - Return address at given depth of user stack backtrace
[`function::usymdata`](https://www.man7.org/linux/man-pages/man3/function::usymdata.3stap.html) - Return the symbol and module offset of an address.
[`function::usymfile`](https://www.man7.org/linux/man-pages/man3/function::usymfile.3stap.html) - Return the file name of a given address.
[`function::usymfileline`](https://www.man7.org/linux/man-pages/man3/function::usymfileline.3stap.html) - Return the file name and line number of an address.
[`function::usymline`](https://www.man7.org/linux/man-pages/man3/function::usymline.3stap.html) - Return the line number of an address.
[`function::usymname`](https://www.man7.org/linux/man-pages/man3/function::usymname.3stap.html) - Return the symbol of an address in the current task.
[`function::vm_fault_contains`](https://www.man7.org/linux/man-pages/man3/function::vm_fault_contains.3stap.html) - Test return value for page fault reason
[`function::warn`](https://www.man7.org/linux/man-pages/man3/function::warn.3stap.html) - Send a line to the warning stream
[`funlockfile`](https://www.man7.org/linux/man-pages/man3/funlockfile.3.html) - lock FILE for stdio
[`funlockfile`](https://www.man7.org/linux/man-pages/man3/funlockfile.3p.html) - stdio locking functions
[`fuse`](https://www.man7.org/linux/man-pages/man4/fuse.4.html) - Filesystem in Userspace (FUSE) device
[`fuse`](https://www.man7.org/linux/man-pages/man8/fuse.8.html) - configuration and mount options for FUSE file systems
[`fuse2fs`](https://www.man7.org/linux/man-pages/man1/fuse2fs.1.html) - FUSE file system client for ext2/ext3/ext4 file systems
[`fuser`](https://www.man7.org/linux/man-pages/man1/fuser.1.html) - identify processes using files or sockets
[`fuser`](https://www.man7.org/linux/man-pages/man1/fuser.1p.html) - list process IDs of all processes that have one or more files open
[`fusermount3`](https://www.man7.org/linux/man-pages/man1/fusermount3.1.html) - mount and unmount FUSE filesystems
[`futex`](https://www.man7.org/linux/man-pages/man2/futex.2.html) - fast user-space locking
[`futex`](https://www.man7.org/linux/man-pages/man7/futex.7.html) - fast user-space locking
[`futimens`](https://www.man7.org/linux/man-pages/man3/futimens.3.html) - change file timestamps with nanosecond precision
[`futimens`](https://www.man7.org/linux/man-pages/man3/futimens.3p.html) - set file access and modification times
[`futimes`](https://www.man7.org/linux/man-pages/man3/futimes.3.html) - change file timestamps
[`futimesat`](https://www.man7.org/linux/man-pages/man2/futimesat.2.html) - change timestamps of a file relative to a directory file descriptor
[`fw`](https://www.man7.org/linux/man-pages/man8/fw.8.html) - fwmark traffic control filter
[`fwide`](https://www.man7.org/linux/man-pages/man3/fwide.3.html) - set and determine the orientation of a FILE stream
[`fwide`](https://www.man7.org/linux/man-pages/man3/fwide.3p.html) - set stream orientation
[`fwprintf`](https://www.man7.org/linux/man-pages/man3/fwprintf.3.html) - formatted wide-character output conversion
[`fwprintf`](https://www.man7.org/linux/man-pages/man3/fwprintf.3p.html) - character output
[`__fwritable`](https://www.man7.org/linux/man-pages/man3/__fwritable.3.html) - interfaces to stdio FILE structure
[`fwrite`](https://www.man7.org/linux/man-pages/man3/fwrite.3.html) - binary stream input/output
[`fwrite`](https://www.man7.org/linux/man-pages/man3/fwrite.3p.html) - binary output
[`fwrite_unlocked`](https://www.man7.org/linux/man-pages/man3/fwrite_unlocked.3.html) - nonlocking stdio functions
[`__fwriting`](https://www.man7.org/linux/man-pages/man3/__fwriting.3.html) - interfaces to stdio FILE structure
[`fwscanf`](https://www.man7.org/linux/man-pages/man3/fwscanf.3p.html) - character input