...
---
[`magic_error`](https://www.man7.org/linux/man-pages/man3/magic_error.3.html) - Magic number recognition library
---
...
---
[`makecontext`](https://www.man7.org/linux/man-pages/man3/makecontext.3.html) - manipulate user context
---
...
---
[`mariadb-dumpslow`](https://www.man7.org/linux/man-pages/man1/mariadb-dumpslow.1.html) - Summarize slow query log files (mariadb-dumpslow is now a symlink to mariadb-dumpslow)
---
[`mariadb-embedded`](https://www.man7.org/linux/man-pages/man1/mariadb-embedded.1.html) - the MariaDB command-line tool (mysql is now a symlink to mariadb)
---
[`mariadb-find-rows`](https://www.man7.org/linux/man-pages/man1/mariadb-find-rows.1.html) - extract SQL statements from files (mariadb-find-rows is now a symlink to mariadb-find-rows)
---
[`mariadb-fix-extensions`](https://www.man7.org/linux/man-pages/man1/mariadb-fix-extensions.1.html) - normalize table file name extensions (mariadb-fix-extensions is now a symlink to mariadb-fix-extensions)
---
[`mariadb-hotcopy`](https://www.man7.org/linux/man-pages/man1/mariadb-hotcopy.1.html) - a database backup program (mariadb-hotcopy is now a symlink to mariadb-hotcopy)
---
[`mariadb-import`](https://www.man7.org/linux/man-pages/man1/mariadb-import.1.html) - a data import program (mariadb-import is now a symlink to mariadb-import)
---
[`mariadb-install-db`](https://www.man7.org/linux/man-pages/man1/mariadb-install-db.1.html) - initialize MariaDB data directory (mariadb-install-db is now a symlink to mariadb-install-db)
---
[`mariadb-plugin`](https://www.man7.org/linux/man-pages/man1/mariadb-plugin.1.html) - configure MariaDB server plugins (mariadb-plugin is now a symlink to mariadb-plugin)
---
[`mariadb-secure-installation`](https://www.man7.org/linux/man-pages/man1/mariadb-secure-installation.1.html) - improve MariaDB installation security (mariadb-secure-installation is now a symlink to mariadb-secure-installation)
---
[`mariadb-service-convert`](https://www.man7.org/linux/man-pages/man1/mariadb-service-convert.1.html) - generate a mariadb.service file based on the current mariadb settings
---
[`mariadb-setpermission`](https://www.man7.org/linux/man-pages/man1/mariadb-setpermission.1.html) - interactively set permissions in grant tables (mariadb-setpermission is now a symlink to mariadb-setpermission)
---
[`mariadb-show`](https://www.man7.org/linux/man-pages/man1/mariadb-show.1.html) - display database, table, and column information (mariadb-show is now a symlink to mariadb-show)
---
[`mariadb-slap`](https://www.man7.org/linux/man-pages/man1/mariadb-slap.1.html) - load emulation client (mariadb-slap is now a symlink to mariadb-slap)
---
[`mariadb-stress-test.pl`](https://www.man7.org/linux/man-pages/man1/mariadb-stress-test.pl.1.html) - server stress test program
---
[`mariadb-test-embedded`](https://www.man7.org/linux/man-pages/man1/mariadb-test-embedded.1.html) - program to run test cases (mariadb-test is now a symlink to mariadb-test)
---
[`mariadb-test-run.pl`](https://www.man7.org/linux/man-pages/man1/mariadb-test-run.pl.1.html) - run MariaDB test suite
---
[`mariadb-test`](https://www.man7.org/linux/man-pages/man1/mariadb-test.1.html) - program to run test cases (mariadb-test is now a symlink to mariadb-test)
---
[`mariadb-tzinfo-to-sql`](https://www.man7.org/linux/man-pages/man1/mariadb-tzinfo-to-sql.1.html) - load the time zone tables (mariadb-tzinfo-to-sql is now a symlink to mariadb-tzinfo-to-sql)
---
[`mariadb-upgrade`](https://www.man7.org/linux/man-pages/man1/mariadb-upgrade.1.html) - check tables for MariaDB upgrade (mariadb-upgrade is now a symlink to mariadb-upgrade)
---
[`mariadb-waitpid`](https://www.man7.org/linux/man-pages/man1/mariadb-waitpid.1.html) - kill process and wait for its termination (mariadb-waitpid is now a symlink to mariadb-waitpid)
---
[`mariadb`](https://www.man7.org/linux/man-pages/man1/mariadb.1.html) - the MariaDB command-line tool (mysql is now a symlink to mariadb)
---
[`mariadb_config`](https://www.man7.org/linux/man-pages/man1/mariadb_config.1.html) - get compile options for compiling clients
---
[`mariadbd-multi`](https://www.man7.org/linux/man-pages/man1/mariadbd-multi.1.html) - manage multiple MariaDB servers (mariadbd-multi is now a symlink to mariadbd-multi)
---
[`mariadbd-safe-helper`](https://www.man7.org/linux/man-pages/man1/mariadbd-safe-helper.1.html) - helper script (mysqld_safe_helper is now a symlink to mariadbd-safe-helper)
---
[`mariadbd-safe`](https://www.man7.org/linux/man-pages/man1/mariadbd-safe.1.html) - MariaDB server startup script (mariadbd-safe is now a symlink to mariadbd-safe)
---
[`mariadbd`](https://www.man7.org/linux/man-pages/man8/mariadbd.8.html) - the MariaDB server (mariadbd is now a symlink to mariadbd)
---
[`matchall`](https://www.man7.org/linux/man-pages/man8/matchall.8.html) - traffic control filter that matches every packet
---
[`matchmediacon`](https://www.man7.org/linux/man-pages/man3/matchmediacon.3.html) - get the default SELinux security context for the specified mediatype from the policy
---
[`matchpathcon`](https://www.man7.org/linux/man-pages/man3/matchpathcon.3.html) - get the default SELinux security context for the specified path from the file contexts configuration
---
[`matchpathcon`](https://www.man7.org/linux/man-pages/man8/matchpathcon.8.html) - get the default SELinux security context for the specified path from the file contexts configuration
---
[`matchpathcon_checkmatches`](https://www.man7.org/linux/man-pages/man3/matchpathcon_checkmatches.3.html) - check and report whether any specification index has no matches with any inode. Maintenance and statistics on inode associations
---
[`matchpathcon_filespec_add`](https://www.man7.org/linux/man-pages/man3/matchpathcon_filespec_add.3.html) - check and report whether any specification index has no matches with any inode. Maintenance and statistics on inode associations
---
[`matchpathcon_filespec_destroy`](https://www.man7.org/linux/man-pages/man3/matchpathcon_filespec_destroy.3.html) - check and report whether any specification index has no matches with any inode. Maintenance and statistics on inode associations
---
[`matchpathcon_filespec_eval`](https://www.man7.org/linux/man-pages/man3/matchpathcon_filespec_eval.3.html) - check and report whether any specification index has no matches with any inode. Maintenance and statistics on inode associations
---
[`matchpathcon_fini`](https://www.man7.org/linux/man-pages/man3/matchpathcon_fini.3.html) - get the default SELinux security context for the specified path from the file contexts configuration
---
[`matchpathcon_index`](https://www.man7.org/linux/man-pages/man3/matchpathcon_index.3.html) - get the default SELinux security context for the specified path from the file contexts configuration
---
[`matchpathcon_init`](https://www.man7.org/linux/man-pages/man3/matchpathcon_init.3.html) - get the default SELinux security context for the specified path from the file contexts configuration
---
[`math.h`](https://www.man7.org/linux/man-pages/man0/math.h.0p.html) - mathematical declarations
---
[`matherr`](https://www.man7.org/linux/man-pages/man3/matherr.3.html) - SVID math library exception handling
---
...
---
[`mbsrtowcs`](https://www.man7.org/linux/man-pages/man3/mbsrtowcs.3.html) - convert a multibyte string to a wide-character string (restartable)
---
...
---
[`media`](https://www.man7.org/linux/man-pages/man5/media.5.html) - userspace SELinux labeling interface and configuration file format for the media contexts backend
---
...
---
[`memusage`](https://www.man7.org/linux/man-pages/man1/memusage.1.html) - profile memory usage of a program
---
...
---
[`menu_request_by_name`](https://www.man7.org/linux/man-pages/man3/menu_request_by_name.3x.html) - handle printable menu request names
---
...
---
[`mkfifo`](https://www.man7.org/linux/man-pages/man3/mkfifo.3.html) - make a FIFO special file (a named pipe)
---
...
---
[`mkostemps`](https://www.man7.org/linux/man-pages/man3/mkostemps.3.html) - create a unique temporary file
---
...
---
[`mlx5dv_ts_to_ns`](https://www.man7.org/linux/man-pages/man3/mlx5dv_ts_to_ns.3.html) - Convert device timestamp from HCA core clock units to the corresponding nanosecond counts
---
...
---
[`mount.fuse3`](https://www.man7.org/linux/man-pages/man8/mount.fuse3.8.html) - configuration and mount options for FUSE file systems
---
...
---
[`mq_close`](https://www.man7.org/linux/man-pages/man3/mq_close.3.html) - close a message queue descriptor
---
...
---
[`mq_timedreceive`](https://www.man7.org/linux/man-pages/man3/mq_timedreceive.3.html) - receive a message from a message queue
---
...
---
[`msync`](https://www.man7.org/linux/man-pages/man3/msync.3p.html) - synchronize memory with physical storage
---
...
---
[`mvwadd_wchnstr`](https://www.man7.org/linux/man-pages/man3/mvwadd_wchnstr.3x.html) - add an array of complex characters (and attributes) to a curses window
---
...
---
[`mvwinsnstr`](https://www.man7.org/linux/man-pages/man3/mvwinsnstr.3x.html) - insert string before cursor in a curses window
---
