...
[`tapset::irq`](https://www.man7.org/linux/man-pages/man3/tapset::irq.3stap.html) - systemtap irq tapset
...
[`tapset::task_ancestry`](https://www.man7.org/linux/man-pages/man3/tapset::task_ancestry.3stap.html) - systemtap task_ancestry tapset
...
[`tc-fq_codel`](https://www.man7.org/linux/man-pages/man8/tc-fq_codel.8.html) - Fair Queuing (FQ) with Controlled Delay (CoDel)
...
[`tc-route`](https://www.man7.org/linux/man-pages/man8/tc-route.8.html) - route traffic control filter
...
[`tcflsh`](https://www.man7.org/linux/man-pages/man2/tcflsh.2const.html) - buffer count and flushing
[`tcflush`](https://www.man7.org/linux/man-pages/man3/tcflush.3.html) - get and set terminal attributes, line control, get and set baud rate
...
[`tcsendbreak`](https://www.man7.org/linux/man-pages/man3/tcsendbreak.3p.html) - send a break for a specific duration
...
[`tep_data_comm_from_pid`](https://www.man7.org/linux/man-pages/man3/tep_data_comm_from_pid.3.html) - Manage pid to process name mappings.
...
[`tep_parse_kallsyms`](https://www.man7.org/linux/man-pages/man3/tep_parse_kallsyms.3.html) - Parsing functions to load mappings
...
[`tep_unregister_event_handler`](https://www.man7.org/linux/man-pages/man3/tep_unregister_event_handler.3.html) - Register / unregisters a callback function to parse an event information.
...
[`tgammaf`](https://www.man7.org/linux/man-pages/man3/tgammaf.3.html) - true gamma function
...
[`times`](https://www.man7.org/linux/man-pages/man1/times.1p.html) - write process times
...
[`tiocttygstruct`](https://www.man7.org/linux/man-pages/man2/tiocttygstruct.2const.html) - kernel debugging
[`tiparm`](https://www.man7.org/linux/man-pages/man3/tiparm.3x.html) - curses interfaces to terminfo database
...
[`towlower`](https://www.man7.org/linux/man-pages/man3/towlower.3p.html) - character code to lowercase
...
[`trace-cmd-extract`](https://www.man7.org/linux/man-pages/man1/trace-cmd-extract.1.html) - extract out the data from the Ftrace Linux tracer.
...
[`tracefs_buffer_stat_commit_overrun`](https://www.man7.org/linux/man-pages/man3/tracefs_buffer_stat_commit_overrun.3.html) - Handling tracing buffer stats
...
[`tracefs_error_all`](https://www.man7.org/linux/man-pages/man3/tracefs_error_all.3.html) - functions to read and clear the tracefs error log.
...
[`tracefs_file_exists`](https://www.man7.org/linux/man-pages/man3/tracefs_file_exists.3.html) - Work with files directories in tracing instances.
[`tracefs_fill_local_events`](https://www.man7.org/linux/man-pages/man3/tracefs_fill_local_events.3.html) - Initialize a tep handler with trace events from the local system.
[`tracefs_filter_functions`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_functions.3.html) - Functions to modify the the function trace filters
[`tracefs_filter_pid_events`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_pid_events.3.html) - Add and remove PID filtering for functions and events
[`tracefs_filter_pid_events_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_pid_events_clear.3.html) - Add and remove PID filtering for functions and events
[`tracefs_filter_pid_function`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_pid_function.3.html) - Add and remove PID filtering for functions and events
[`tracefs_filter_pid_function_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_pid_function_clear.3.html) - Add and remove PID filtering for functions and events
[`tracefs_filter_string_append`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_string_append.3.html) - Add, verify and apply event filters
[`tracefs_filter_string_verify`](https://www.man7.org/linux/man-pages/man3/tracefs_filter_string_verify.3.html) - Add, verify and apply event filters
[`tracefs_find_cid_pid`](https://www.man7.org/linux/man-pages/man3/tracefs_find_cid_pid.3.html) - helper functions to handle tracing guests
[`tracefs_follow_event`](https://www.man7.org/linux/man-pages/man3/tracefs_follow_event.3.html) - Iterate over events in the ring buffer
[`tracefs_follow_event_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_follow_event_clear.3.html) - Iterate over events in the ring buffer
[`tracefs_follow_missed_events`](https://www.man7.org/linux/man-pages/man3/tracefs_follow_missed_events.3.html) - Iterate over events in the ring buffer
[`tracefs_follow_missed_events_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_follow_missed_events_clear.3.html) - Iterate over events in the ring buffer
[`tracefs_function_filter`](https://www.man7.org/linux/man-pages/man3/tracefs_function_filter.3.html) - Functions to modify the the function trace filters
[`tracefs_function_notrace`](https://www.man7.org/linux/man-pages/man3/tracefs_function_notrace.3.html) - Functions to modify the the function trace filters
[`tracefs_get_clock`](https://www.man7.org/linux/man-pages/man3/tracefs_get_clock.3.html) - Helper functions for working with trace file system.
[`tracefs_get_tracing_file`](https://www.man7.org/linux/man-pages/man3/tracefs_get_tracing_file.3.html) - Find and set locations of trace directory and files.
[`tracefs_hist_add_key`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_add_key.3.html) - Create and destroy event histograms
[`tracefs_hist_add_key_cnt`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_add_key_cnt.3.html) - Create and destroy event histograms
[`tracefs_hist_add_name`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_add_name.3.html) - Update and describe an event histogram
[`tracefs_hist_add_sort_key`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_add_sort_key.3.html) - Update and describe an event histogram
[`tracefs_hist_add_value`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_add_value.3.html) - Create and destroy event histograms
[`tracefs_hist_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_alloc.3.html) - Create and destroy event histograms
[`tracefs_hist_alloc_2d`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_alloc_2d.3.html) - Create and destroy event histograms
[`tracefs_hist_alloc_nd`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_alloc_nd.3.html) - Create and destroy event histograms
[`tracefs_hist_alloc_nd_cnt`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_alloc_nd_cnt.3.html) - Create and destroy event histograms
[`tracefs_hist_append_filter`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_append_filter.3.html) - Update and describe an event histogram
[`tracefs_hist_command`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_command.3.html) - Update and describe an event histogram
[`tracefs_hist_continue`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_continue.3.html) - Pause, continue, or clear an existing histogram
[`tracefs_hist_destroy`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_destroy.3.html) - Pause, continue, or clear an existing histogram
[`tracefs_hist_echo_cmd`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_echo_cmd.3.html) - Update and describe an event histogram
[`tracefs_hist_free`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_free.3.html) - Create and destroy event histograms
[`tracefs_hist_get_event`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_get_event.3.html) - Update and describe an event histogram
[`tracefs_hist_get_name`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_get_name.3.html) - Update and describe an event histogram
[`tracefs_hist_get_system`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_get_system.3.html) - Update and describe an event histogram
[`tracefs_hist_pause`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_pause.3.html) - Pause, continue, or clear an existing histogram
[`tracefs_hist_reset`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_reset.3.html) - Pause, continue, or clear an existing histogram
[`tracefs_hist_set_sort_key`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_set_sort_key.3.html) - Update and describe an event histogram
[`tracefs_hist_sort_key_direction`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_sort_key_direction.3.html) - Update and describe an event histogram
[`tracefs_hist_start`](https://www.man7.org/linux/man-pages/man3/tracefs_hist_start.3.html) - Pause, continue, or clear an existing histogram
[`tracefs_instance_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_alloc.3.html) - Manage trace instances.
[`tracefs_instance_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_clear.3.html) - Manage trace instances.
[`tracefs_instance_create`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_create.3.html) - Manage trace instances.
[`tracefs_instance_destroy`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_destroy.3.html) - Manage trace instances.
[`tracefs_instance_exists`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_exists.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_file_append`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_append.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_clear.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_open`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_open.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_read`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_read.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_read_number`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_read_number.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_write`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_write.3.html) - Work with files in tracing instances.
[`tracefs_instance_file_write_number`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_file_write_number.3.html) - Work with files in tracing instances.
[`tracefs_instance_find_cid_pid`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_find_cid_pid.3.html) - helper functions to handle tracing guests
[`tracefs_instance_free`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_free.3.html) - Manage trace instances.
[`tracefs_instance_get_affinity`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_affinity.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_get_affinity_raw`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_affinity_raw.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_get_affinity_set`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_affinity_set.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_get_buffer_percent`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_buffer_percent.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_get_buffer_size`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_buffer_size.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_get_dir`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_dir.3.html) - Work with files directories in tracing instances.
[`tracefs_instance_get_file`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_file.3.html) - Work with files directories in tracing instances.
[`tracefs_instance_get_name`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_name.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_get_stat`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_stat.3.html) - Handling tracing buffer stats
[`tracefs_instance_get_subbuf_size`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_subbuf_size.3.html) - Helper functions for working with ring buffer sub buffers.
[`tracefs_instance_get_trace_dir`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_get_trace_dir.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_is_new`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_is_new.3.html) - Manage trace instances.
[`tracefs_instance_put_stat`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_put_stat.3.html) - Handling tracing buffer stats
[`tracefs_instance_reset`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_reset.3.html) - Manage trace instances.
[`tracefs_instances`](https://www.man7.org/linux/man-pages/man3/tracefs_instances.3.html) - Manage trace instances.
[`tracefs_instance_set_affinity`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_affinity.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_set_affinity_raw`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_affinity_raw.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_set_affinity_set`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_affinity_set.3.html) - Sets or retrieves the affinity for an instance or top level for what CPUs enable tracing.
[`tracefs_instance_set_buffer_percent`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_buffer_percent.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_set_buffer_size`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_buffer_size.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_set_subbuf_size`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_set_subbuf_size.3.html) - Helper functions for working with ring buffer sub buffers.
[`tracefs_instances_walk`](https://www.man7.org/linux/man-pages/man3/tracefs_instances_walk.3.html) - Helper functions for working with tracing instances.
[`tracefs_instance_tracers`](https://www.man7.org/linux/man-pages/man3/tracefs_instance_tracers.3.html) - Enable or disable a tracer in an instance or the top level
[`tracefs_iterate_raw_events`](https://www.man7.org/linux/man-pages/man3/tracefs_iterate_raw_events.3.html) - Iterate over events in the ring buffer
[`tracefs_iterate_snapshot_events`](https://www.man7.org/linux/man-pages/man3/tracefs_iterate_snapshot_events.3.html) - Iterate over events in the ring buffer
[`tracefs_iterate_stop`](https://www.man7.org/linux/man-pages/man3/tracefs_iterate_stop.3.html) - Iterate over events in the ring buffer
[`tracefs_kprobe_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_kprobe_alloc.3.html) - Allocate, get, create, and remove kprobes
[`tracefs_kprobe_destroy`](https://www.man7.org/linux/man-pages/man3/tracefs_kprobe_destroy.3.html) - Allocate, get, create, and remove kprobes
[`tracefs_kprobe_raw`](https://www.man7.org/linux/man-pages/man3/tracefs_kprobe_raw.3.html) - Allocate, get, create, and remove kprobes
[`tracefs_kretprobe_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_kretprobe_alloc.3.html) - Allocate, get, create, and remove kprobes
[`tracefs_kretprobe_raw`](https://www.man7.org/linux/man-pages/man3/tracefs_kretprobe_raw.3.html) - Allocate, get, create, and remove kprobes
[`tracefs_list_add`](https://www.man7.org/linux/man-pages/man3/tracefs_list_add.3.html) - Helper functions for working with trace file system.
[`tracefs_list_free`](https://www.man7.org/linux/man-pages/man3/tracefs_list_free.3.html) - Helper functions for working with trace file system.
[`tracefs_list_size`](https://www.man7.org/linux/man-pages/man3/tracefs_list_size.3.html) - Helper functions for working with trace file system.
[`tracefs_load_cmdlines`](https://www.man7.org/linux/man-pages/man3/tracefs_load_cmdlines.3.html) - Initialize a tep handler with trace events from the local system.
[`tracefs_load_headers`](https://www.man7.org/linux/man-pages/man3/tracefs_load_headers.3.html) - Initialize a tep handler with trace events from the local system.
[`tracefs_local_events`](https://www.man7.org/linux/man-pages/man3/tracefs_local_events.3.html) - Initialize a tep handler with trace events from the local system.
[`tracefs_local_events_system`](https://www.man7.org/linux/man-pages/man3/tracefs_local_events_system.3.html) - Initialize a tep handler with trace events from the local system.
[`tracefs_mapped_is_supported`](https://www.man7.org/linux/man-pages/man3/tracefs_mapped_is_supported.3.html) - Memory mapping of the ring buffer
[`tracefs_option_disable`](https://www.man7.org/linux/man-pages/man3/tracefs_option_disable.3.html) - Various trace option functions.
[`tracefs_option_enable`](https://www.man7.org/linux/man-pages/man3/tracefs_option_enable.3.html) - Various trace option functions.
[`tracefs_option_id`](https://www.man7.org/linux/man-pages/man3/tracefs_option_id.3.html) - Get and check ftrace options.
[`tracefs_option_is_enabled`](https://www.man7.org/linux/man-pages/man3/tracefs_option_is_enabled.3.html) - Get and check ftrace options.
[`tracefs_option_is_supported`](https://www.man7.org/linux/man-pages/man3/tracefs_option_is_supported.3.html) - Get and check ftrace options.
[`tracefs_option_mask_is_set`](https://www.man7.org/linux/man-pages/man3/tracefs_option_mask_is_set.3.html) - Get and check ftrace options.
[`tracefs_option_name`](https://www.man7.org/linux/man-pages/man3/tracefs_option_name.3.html) - Various trace option functions.
[`tracefs_options`](https://www.man7.org/linux/man-pages/man3/tracefs_options.3.html) - ftrace options, that can be controlled using tracefs library.
[`tracefs_options_get_enabled`](https://www.man7.org/linux/man-pages/man3/tracefs_options_get_enabled.3.html) - Get and check ftrace options.
[`tracefs_options_get_supported`](https://www.man7.org/linux/man-pages/man3/tracefs_options_get_supported.3.html) - Get and check ftrace options.
[`tracefs_print_close`](https://www.man7.org/linux/man-pages/man3/tracefs_print_close.3.html) - Open, close and write formated strings in the trace buffer.
[`tracefs_printf`](https://www.man7.org/linux/man-pages/man3/tracefs_printf.3.html) - Open, close and write formated strings in the trace buffer.
[`tracefs_print_init`](https://www.man7.org/linux/man-pages/man3/tracefs_print_init.3.html) - Open, close and write formated strings in the trace buffer.
[`tracefs_put_tracing_file`](https://www.man7.org/linux/man-pages/man3/tracefs_put_tracing_file.3.html) - Find and set locations of trace directory and files.
[`tracefs_set_loglevel`](https://www.man7.org/linux/man-pages/man3/tracefs_set_loglevel.3.html) - Set log level of the library
[`tracefs_set_tracing_dir`](https://www.man7.org/linux/man-pages/man3/tracefs_set_tracing_dir.3.html) - Find and set locations of trace directory and files.
[`tracefs_snapshot_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_snapshot_clear.3.html) - API to create, clear and read snapshots
[`tracefs_snapshot_free`](https://www.man7.org/linux/man-pages/man3/tracefs_snapshot_free.3.html) - API to create, clear and read snapshots
[`tracefs_snapshot_snap`](https://www.man7.org/linux/man-pages/man3/tracefs_snapshot_snap.3.html) - API to create, clear and read snapshots
[`tracefs_sql`](https://www.man7.org/linux/man-pages/man3/tracefs_sql.3.html) - Create a synthetic event via an SQL statement
[`tracefs_synth_add_compare_field`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_add_compare_field.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_add_end_field`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_add_end_field.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_add_match_field`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_add_match_field.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_add_start_field`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_add_start_field.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_alloc.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_append_end_filter`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_append_end_filter.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_append_start_filter`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_append_start_filter.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_complete`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_complete.3.html) - Creation of synthetic events
[`tracefs_synth_create`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_create.3.html) - Creation of synthetic events
[`tracefs_synth_destroy`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_destroy.3.html) - Creation of synthetic events
[`tracefs_synth_echo_cmd`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_echo_cmd.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_free`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_free.3.html) - Creation of a synthetic event descriptor
[`tracefs_synth_get_event`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_get_event.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_get_name`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_get_name.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_get_start_hist`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_get_start_hist.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_raw_fmt`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_raw_fmt.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_save`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_save.3.html) - Creation of synthetic events
[`tracefs_synth_set_instance`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_set_instance.3.html) - Creation of synthetic events
[`tracefs_synth_show_end_hist`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_show_end_hist.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_show_event`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_show_event.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_show_start_hist`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_show_start_hist.3.html) - Retrieve data of synthetic events.
[`tracefs_synth_snapshot`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_snapshot.3.html) - Creation of synthetic events
[`tracefs_synth_trace`](https://www.man7.org/linux/man-pages/man3/tracefs_synth_trace.3.html) - Creation of synthetic events
[`tracefs_system_events`](https://www.man7.org/linux/man-pages/man3/tracefs_system_events.3.html) - Work with trace systems and events.
[`tracefs_time_conversion`](https://www.man7.org/linux/man-pages/man3/tracefs_time_conversion.3.html) - helper functions to handle tracing guests
[`tracefs_trace_is_on`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_is_on.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_off`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_off.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_off_fd`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_off_fd.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_on`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_on.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_on_fd`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_on_fd.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_on_get_fd`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_on_get_fd.3.html) - Functions to enable or disable tracing.
[`tracefs_trace_pipe_print`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_pipe_print.3.html) - redirect the stream of trace data to an output or stdout.
[`tracefs_trace_pipe_stop`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_pipe_stop.3.html) - redirect the stream of trace data to an output or stdout.
[`tracefs_trace_pipe_stream`](https://www.man7.org/linux/man-pages/man3/tracefs_trace_pipe_stream.3.html) - redirect the stream of trace data to an output or stdout.
[`tracefs_tracer_available`](https://www.man7.org/linux/man-pages/man3/tracefs_tracer_available.3.html) - Helper functions for working with trace file system.
[`tracefs_tracer_clear`](https://www.man7.org/linux/man-pages/man3/tracefs_tracer_clear.3.html) - Enable or disable a tracer in an instance or the top level
[`tracefs_tracers`](https://www.man7.org/linux/man-pages/man3/tracefs_tracers.3.html) - Helper functions for working with trace file system.
[`tracefs_tracer_set`](https://www.man7.org/linux/man-pages/man3/tracefs_tracer_set.3.html) - Enable or disable a tracer in an instance or the top level
[`tracefs_tracing_dir`](https://www.man7.org/linux/man-pages/man3/tracefs_tracing_dir.3.html) - Find and set locations of trace directory and files.
[`tracefs_tracing_dir_is_mounted`](https://www.man7.org/linux/man-pages/man3/tracefs_tracing_dir_is_mounted.3.html) - Find and set locations of trace directory and files.
[`tracefs_uprobe_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_uprobe_alloc.3.html) - Allocate new user (return) probe
[`tracefs_uretprobe_alloc`](https://www.man7.org/linux/man-pages/man3/tracefs_uretprobe_alloc.3.html) - Allocate new user (return) probe
[`tracefs_vprintf`](https://www.man7.org/linux/man-pages/man3/tracefs_vprintf.3.html) - Open, close and write formated strings in the trace buffer.
[`tracelog`](https://www.man7.org/linux/man-pages/man3/tracelog.3.html) - LTTng-UST printf-like interface with a log level
[`_tracemouse`](https://www.man7.org/linux/man-pages/man3/_tracemouse.3x.html) - curses debugging routines
[`tracepath`](https://www.man7.org/linux/man-pages/man8/tracepath.8.html) - traces path to a network host discovering MTU along this path
[`tracepoint`](https://www.man7.org/linux/man-pages/man3/tracepoint.3.html) - LTTng user space tracing
[`tracepoint_enabled`](https://www.man7.org/linux/man-pages/man3/tracepoint_enabled.3.html) - LTTng user space tracing
[`traceroute`](https://www.man7.org/linux/man-pages/man8/traceroute.8.html) - print the route packets trace to network host
[`trace_seq_destroy`](https://www.man7.org/linux/man-pages/man3/trace_seq_destroy.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_do_fprintf`](https://www.man7.org/linux/man-pages/man3/trace_seq_do_fprintf.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_do_printf`](https://www.man7.org/linux/man-pages/man3/trace_seq_do_printf.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_init`](https://www.man7.org/linux/man-pages/man3/trace_seq_init.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_printf`](https://www.man7.org/linux/man-pages/man3/trace_seq_printf.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_putc`](https://www.man7.org/linux/man-pages/man3/trace_seq_putc.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_puts`](https://www.man7.org/linux/man-pages/man3/trace_seq_puts.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_reset`](https://www.man7.org/linux/man-pages/man3/trace_seq_reset.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_terminate`](https://www.man7.org/linux/man-pages/man3/trace_seq_terminate.3.html) - Initialize / destroy a trace sequence.
[`trace_seq_vprintf`](https://www.man7.org/linux/man-pages/man3/trace_seq_vprintf.3.html) - Initialize / destroy a trace sequence.
[`trafgen`](https://www.man7.org/linux/man-pages/man8/trafgen.8.html) - a fast, multithreaded network packet generator
[`trap`](https://www.man7.org/linux/man-pages/man1/trap.1p.html) - trap signals
[`troff` -](https://www.man7.org/linux/man-pages/man1/troff.1.html) - (no description)
[`true`](https://www.man7.org/linux/man-pages/man1/true.1.html) - do nothing, successfully
[`true`](https://www.man7.org/linux/man-pages/man1/true.1p.html) - return true value
[`trunc`](https://www.man7.org/linux/man-pages/man3/trunc.3.html) - round to integer, toward zero
[`trunc`](https://www.man7.org/linux/man-pages/man3/trunc.3p.html) - round to truncated integer value
[`truncate`](https://www.man7.org/linux/man-pages/man1/truncate.1.html) - shrink or extend the size of a file to the specified size
[`truncate`](https://www.man7.org/linux/man-pages/man2/truncate.2.html) - truncate a file to a specified length
[`truncate`](https://www.man7.org/linux/man-pages/man3/truncate.3p.html) - truncate a file to a specified length
[`truncate64`](https://www.man7.org/linux/man-pages/man2/truncate64.2.html) - truncate a file to a specified length
[`truncf`](https://www.man7.org/linux/man-pages/man3/truncf.3.html) - round to integer, toward zero
[`truncf`](https://www.man7.org/linux/man-pages/man3/truncf.3p.html) - round to truncated integer value
[`truncl`](https://www.man7.org/linux/man-pages/man3/truncl.3.html) - round to integer, toward zero
[`truncl`](https://www.man7.org/linux/man-pages/man3/truncl.3p.html) - round to truncated integer value
[`tsearch`](https://www.man7.org/linux/man-pages/man3/tsearch.3.html) - manage a binary search tree
[`tsearch`](https://www.man7.org/linux/man-pages/man3/tsearch.3p.html) - search a binary search tree
[`TSET`](https://www.man7.org/linux/man-pages/man1/TSET.1.html) - terminal initialization
[`tset`](https://www.man7.org/linux/man-pages/man1/tset.1.html) - terminal initialization
[`tsort`](https://www.man7.org/linux/man-pages/man1/tsort.1.html) - perform topological sort
[`tsort`](https://www.man7.org/linux/man-pages/man1/tsort.1p.html) - topological sort
[`tty`](https://www.man7.org/linux/man-pages/man1/tty.1.html) - print the file name of the terminal connected to standard input
[`tty`](https://www.man7.org/linux/man-pages/man1/tty.1p.html) - return user's terminal name
[`tty`](https://www.man7.org/linux/man-pages/man4/tty.4.html) - controlling terminal
[`tty_ioctl`](https://www.man7.org/linux/man-pages/man4/tty_ioctl.4.html) - ioctls for terminals and serial lines
[`ttyname`](https://www.man7.org/linux/man-pages/man3/ttyname.3.html) - return name of a terminal
[`ttyname`](https://www.man7.org/linux/man-pages/man3/ttyname.3p.html) - find the pathname of a terminal
[`ttyname_r`](https://www.man7.org/linux/man-pages/man3/ttyname_r.3.html) - return name of a terminal
[`ttyname_r`](https://www.man7.org/linux/man-pages/man3/ttyname_r.3p.html) - find the pathname of a terminal
[`ttyS`](https://www.man7.org/linux/man-pages/man4/ttyS.4.html) - serial terminal lines
[`ttys`](https://www.man7.org/linux/man-pages/man4/ttys.4.html) - serial terminal lines
[`ttyslot`](https://www.man7.org/linux/man-pages/man3/ttyslot.3.html) - find the slot of the current user's terminal in some file
[`ttytype`](https://www.man7.org/linux/man-pages/man3/ttytype.3x.html) - curses terminfo global variables
[`ttytype`](https://www.man7.org/linux/man-pages/man5/ttytype.5.html) - terminal device to default terminal type mapping
[`tune2fs`](https://www.man7.org/linux/man-pages/man8/tune2fs.8.html) - adjust tunable file system parameters on ext2/ext3/ext4 file systems
[`tunnel_key`](https://www.man7.org/linux/man-pages/man8/tunnel_key.8.html) - Tunnel metadata manipulation
[`tuxcall`](https://www.man7.org/linux/man-pages/man2/tuxcall.2.html) - unimplemented system calls
[`twalk`](https://www.man7.org/linux/man-pages/man3/twalk.3.html) - manage a binary search tree
[`twalk`](https://www.man7.org/linux/man-pages/man3/twalk.3p.html) - traverse a binary search tree
[`twalk_r`](https://www.man7.org/linux/man-pages/man3/twalk_r.3.html) - manage a binary search tree
[`txrecord`](https://www.man7.org/linux/man-pages/man1/txrecord.1.html) - txmon performance metrics domain agent (PMDA)
[`type`](https://www.man7.org/linux/man-pages/man1/type.1p.html) - write a description of command type
[`typeahead`](https://www.man7.org/linux/man-pages/man3/typeahead.3x.html) - curses input options
[`TYPE_ALNUM`](https://www.man7.org/linux/man-pages/man3/TYPE_ALNUM.3x.html) - form system global variables
[`TYPE_ALPHA`](https://www.man7.org/linux/man-pages/man3/TYPE_ALPHA.3x.html) - form system global variables
[`TYPE_ENUM`](https://www.man7.org/linux/man-pages/man3/TYPE_ENUM.3x.html) - form system global variables
[`TYPE_INTEGER`](https://www.man7.org/linux/man-pages/man3/TYPE_INTEGER.3x.html) - form system global variables
[`TYPE_IPV4`](https://www.man7.org/linux/man-pages/man3/TYPE_IPV4.3x.html) - form system global variables
[`TYPE_NUMERIC`](https://www.man7.org/linux/man-pages/man3/TYPE_NUMERIC.3x.html) - form system global variables
[`TYPE_REGEXP`](https://www.man7.org/linux/man-pages/man3/TYPE_REGEXP.3x.html) - form system global variables
[`tzfile`](https://www.man7.org/linux/man-pages/man5/tzfile.5.html) - timezone information
[`tzname`](https://www.man7.org/linux/man-pages/man3/tzname.3.html) - initialize time conversion information
[`tzname`](https://www.man7.org/linux/man-pages/man3/tzname.3p.html) - set timezone conversion information
[`tzselect`](https://www.man7.org/linux/man-pages/man8/tzselect.8.html) - select a timezone
[`tzset`](https://www.man7.org/linux/man-pages/man3/tzset.3.html) - initialize time conversion information
[`tzset`](https://www.man7.org/linux/man-pages/man3/tzset.3p.html) - set timezone conversion information