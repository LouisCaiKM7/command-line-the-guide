# Start with P
    ...
    pcre2serialize - Perl-compatible regular expressions (revised API)
    ...
    pmdaCacheLookupName - manage a cache of instance domain information for a PMDA
    ...
    pmHighResFetch - get performance metric values
    ...
    pmtimespecDec - helper routines for time stored as a struct timespec
    ...
    proc_thread-self - thread information
    proc_tid - thread information
    ...
    pr_set_keepcaps - set the state of the "keep capabilities" flag
    PR_SET_MDWE - set the Memory-Deny-Write-Execute protection mask for the calling process
    pr_set_mdwe - set the Memory-Deny-Write-Execute protection mask for the calling process
    PR_SET_MM - modify kernel memory map descriptor fields
    pr_set_mm - modify kernel memory map descriptor fields
    PR_SET_MM_ARG_END - modify kernel memory map descriptor fields
    pr_set_mm_arg_end - modify kernel memory map descriptor fields
    PR_SET_MM_ARG_START - modify kernel memory map descriptor fields
    pr_set_mm_arg_start - modify kernel memory map descriptor fields
    PR_SET_MM_AUXV - set a new auxiliary vector
    pr_set_mm_auxv - set a new auxiliary vector
    PR_SET_MM_BRK - modify kernel memory map descriptor fields
    pr_set_mm_brk - modify kernel memory map descriptor fields
    PR_SET_MM_END_CODE - modify kernel memory map descriptor fields
    pr_set_mm_end_code - modify kernel memory map descriptor fields
    PR_SET_MM_END_DATA - modify kernel memory map descriptor fields
    pr_set_mm_end_data - modify kernel memory map descriptor fields
    PR_SET_MM_ENV_END - modify kernel memory map descriptor fields
    pr_set_mm_env_end - modify kernel memory map descriptor fields
    PR_SET_MM_ENV_START - modify kernel memory map descriptor fields
    pr_set_mm_env_start - modify kernel memory map descriptor fields
    PR_SET_MM_EXE_FILE - modify kernel memory map descriptor fields
    pr_set_mm_exe_file - modify kernel memory map descriptor fields
    PR_SET_MM_MAP - modify kernel memory map descriptor fields
    pr_set_mm_map - modify kernel memory map descriptor fields
    PR_SET_MM_MAP_SIZE - modify kernel memory map descriptor fields
    pr_set_mm_map_size - modify kernel memory map descriptor fields
    ...
    pr_set_mm_start_code - modify kernel memory map descriptor fields
    PR_SET_MM_START_DATA - modify kernel memory map descriptor fields
    pr_set_mm_start_data - modify kernel memory map descriptor fields
    PR_SET_MM_START_STACK - modify kernel memory map descriptor fields
    pr_set_mm_start_stack - modify kernel memory map descriptor fields
    PR_SET_NAME - operations on a process or thread
    pr_set_name - operations on a process or thread
    ...
    pr_set_pdeathsig - set the parent-death signal of the calling process
    PR_SET_PTRACER - allow processes to ptrace the calling process
    pr_set_ptracer - allow processes to ptrace the calling process
    ...
    pr_set_speculation_ctrl - set the state of a speculation misfeature for the calling thread
    PR_SET_SYSCALL_USER_DISPATCH - set the system-call user dispatch mechanism for the calling thread
    pr_set_syscall_user_dispatch - set the system-call user dispatch mechanism for the calling thread
    ...
    pr_sve_set_vl - set the thread's SVE vector length
    PR_TASK_PERF_EVENTS_DISABLE - disable or enable performance counters attached to the calling process
    pr_task_perf_events_disable - disable or enable performance counters attached to the calling process
    PR_TASK_PERF_EVENTS_ENABLE - disable or enable performance counters attached to the calling process
    pr_task_perf_events_enable - disable or enable performance counters attached to the calling process
    ...
    psignal - write signal information to standard error
    ...
    psx_load_syscalls - POSIX semantics for system calls
    psx_set_sensitivity - POSIX semantics for system calls
    psx_syscall - POSIX semantics for system calls
    __psx_syscall - POSIX semantics for system calls
    psx_syscall3 - POSIX semantics for system calls
    psx_syscall6 - POSIX semantics for system calls
    pthread.h - threads
    ...
    pthread_barrierattr_getpshared - shared attribute of the barrier attributes object
    pthread_barrierattr_init - initialize the barrier attributes object
    pthread_barrierattr_setpshared - shared attribute of the barrier attributes object
    ...
    pthread_cleanup_pop - push and pop thread cancelation clean-up handlers
    pthread_cleanup_pop - establish cancellation handlers
    pthread_cleanup_pop_restore_np - push and pop thread cancelation clean-up handlers while saving cancelability type
    ...
    pthread_condattr_getpshared - shared condition variable attributes
    ...
    pthread_condattr_setpshared - shared condition variable attribute
    pthread_cond_broadcast - operations on conditions
    ...
    pthread_cond_signal - operations on conditions
    ...
    pthread_cond_wait - operations on conditions
    ...
    pthread_getcpuclockid - time clock (ADVANCED REALTIME THREADS)
    ...
    pthread_getspecific - specific data management
    pthread_join - join with a terminated thread
    pthread_join - wait for thread termination
    pthread_key_create - management of thread-specific data
    pthread_key_create - specific data key creation
    pthread_key_delete - management of thread-specific data
    pthread_key_delete - specific data key deletion
    pthread_kill - send a signal to a thread
    pthread_kill - send a signal to a thread
    pthread_kill_other_threads_np - terminate all other threads in process
    pthread_mutexattr_destroy - initialize and destroy a mutex attributes object
    pthread_mutexattr_destroy - destroy and initialize the mutex attributes object
    pthread_mutexattr_getkind_np - deprecated mutex creation attributes
    ...
    pthread_mutexattr_getpshared - shared attribute
    ...
    pthread_mutexattr_gettype - initialize and destroy a mutex attributes object
    ...
    pthread_mutexattr_setpshared - shared attribute
    ...
    pthread_mutexattr_settype - initialize and destroy a mutex attributes object
    ...
    pthread_mutex_lock - operations on mutexes
    ...
    pthread_mutex_trylock - operations on mutexes
    pthread_mutex_trylock - lock and unlock a mutex
    pthread_mutex_unlock - operations on mutexes
    pthread_mutex_unlock - lock and unlock a mutex
    pthread_once - once-only initialization
    pthread_once - dynamic package initialization
    pthread_rwlockattr_destroy - write lock attributes object
    pthread_rwlockattr_getkind_np - set/get the read-write lock kind of the thread read-write lock attribute object
    pthread_rwlockattr_getpshared - shared attribute of the read-write lock attributes object
    pthread_rwlockattr_init - write lock attributes object
    pthread_rwlockattr_setkind_np - set/get the read-write lock kind of the thread read-write lock attribute object
    pthread_rwlockattr_setpshared - shared attribute of the read-write lock attributes object
    pthread_rwlock_destroy - write lock object
    pthread_rwlock_init - write lock object
    pthread_rwlock_rdlock - write lock object for reading
    pthread_rwlock_timedrdlock - write lock for reading
    pthread_rwlock_timedwrlock - write lock for writing
    pthread_rwlock_tryrdlock - write lock object for reading
    pthread_rwlock_trywrlock - write lock object for writing
    pthread_rwlock_unlock - write lock object
    pthread_rwlock_wrlock - write lock object for writing
    ...
    pthread_setspecific - management of thread-specific data
    pthread_setspecific - specific data management
